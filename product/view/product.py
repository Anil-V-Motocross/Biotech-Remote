...
def product(request):
    if request.method == 'POST':
        ...
        main_product.default_selling_price = first_product.selling_price
        main_product.default_mrp = first_product.mrp
        main_product.default_discount_amount = first_product.discount_amount
