...
from .view.default_product import default_product, default_item
from .view.filter_product import filter_product, filter_item
...
urlpatterns = [
    ...
    path('defaultProduct/<int:product_id>/', default_item, name='default_product'),
    path('filterProduct/<int:pk>/', filter_item, name='filter_product'),
