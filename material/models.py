...
# # Optional Tables for Normalization
...
#         if ratings.exists():
#             self.average_rating = sum(r.product_rating for r in ratings) / ratings.count()
#             self.save()
...
#     class Meta:
#         unique_together = ('inventory_item', 'size', 'color', 'pot_type', 'litre')  

#     def __str__(self):
#         return f"{self.inventory_item.name} - {self.size.name} - {self.color.name} - {self.pot_type.name} - {self.litre}L"
...
#     class Meta:
#         unique_together = ('inventory_item', 'size', 'color', 'handle_material', 'blade_material')  

#     def __str__(self):
#         return f"{self.inventory_item.name} - {self.size.name} - {self.color.name} - {self.handle_material.name} - {self.blade_material.name}"
